...
public class e2Test extends TestCase {
	public void test() throws Exception {
		try{
			plata pl = new plata();
			pl.arrTf[3].setText("9.49");//gas
            pl.arrTf[4].setText("4");//kolichestvo projivayuchih
            pl.arrTf[5].setText("296");//v potrachennogo gasa
            pl.arrTf[9].setText("8");//kommunalnye uslugy
            pl.arrTf[10].setText("0");//dolg
            pl.arrTf[11].setText("35");//pereplata
            pl.arrTf[12].setText("15503");//Cena na cold water
            pl.arrTf[13].setText("12717.06");//Cena na hot water
            pl.arrTf[15].setText("2352.06");//Cena na svet
            pl.kvartira();
            assertEquals("2809,04", pl.arrTf[14].getText());//Cena na gas
        	assertEquals("32,00", pl.arrTf[16].getText());//Cena na kommunalnye uslugy
        	assertEquals("33378,16", pl.arrTf[17].getText());//summa
